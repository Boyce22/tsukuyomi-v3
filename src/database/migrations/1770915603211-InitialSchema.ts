...
export class InitialSchema1770915603211 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_90b26bd18cd9d223f712779981" ON "c0"."chapters" ("mangaId", "number") `,
    );
    await queryRunner.query(
      `CREATE TABLE "c0"."ratings" ("id" uuid NOT NULL, "score" numeric(3,2) NOT NULL, "review" text, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "mangaId" uuid NOT NULL, CONSTRAINT "PK_0f31425b073219379545ad68ed9" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_3bb7728fb6d59d88eef4bc0781" ON "c0"."ratings" ("userId", "mangaId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "c0"."favorites" ("id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "mangaId" uuid NOT NULL, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "c0"."reading_history_status_enum" AS ENUM('reading', 'completed', 'on_hold', 'dropped', 'plan_to_read')`,
    );
    await queryRunner.query(
      `CREATE TABLE "c0"."reading_history" ("id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "chaptersRead" integer NOT NULL DEFAULT '0', "pagesRead" integer NOT NULL DEFAULT '0', "lastChapterReadId" uuid, "lastPageReadId" uuid, "lastReadAt" TIMESTAMP WITH TIME ZONE, "userId" uuid NOT NULL, "mangaId" uuid NOT NULL, "status" "c0"."reading_history_status_enum" NOT NULL DEFAULT 'reading', CONSTRAINT "PK_fea39783024da119636add4bc21" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "c0"."comments_closure" ("id_ancestor" uuid NOT NULL, "id_descendant" uuid NOT NULL, CONSTRAINT "PK_a02e5093a5d47a64f1fd473d1ef" PRIMARY KEY ("id_ancestor", "id_descendant"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_89a2762362d968c2939b6fab19" ON "c0"."comments_closure" ("id_ancestor") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d2164211fd6ab117cfb2ab8ba9" ON "c0"."comments_closure" ("id_descendant") `,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."tags" ADD CONSTRAINT "FK_e56de5f3dcb3c112de1e983b8e7" FOREIGN KEY ("createdById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."tags" ADD CONSTRAINT "FK_613bccbbe697ffcb6d454c8c137" FOREIGN KEY ("updatedById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."pages" ADD CONSTRAINT "FK_ff5d10b3ea5b3295cf2ac4f24e4" FOREIGN KEY ("chapterId") REFERENCES "c0"."chapters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."pages" ADD CONSTRAINT "FK_bb4fdf76de17813bc13db0bf0d2" FOREIGN KEY ("createdById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."pages" ADD CONSTRAINT "FK_abca8d9b8b2493ed32972042b27" FOREIGN KEY ("updatedById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments" ADD CONSTRAINT "FK_73ac4fbcb3bde1d213db60d2cbf" FOREIGN KEY ("mangaId") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments" ADD CONSTRAINT "FK_8dc14e6a6a0c24a0ce1bc74380d" FOREIGN KEY ("chapterId") REFERENCES "c0"."chapters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments" ADD CONSTRAINT "FK_7e8d7c49f218ebb14314fdb3749" FOREIGN KEY ("userId") REFERENCES "c0"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments" ADD CONSTRAINT "FK_4875672591221a61ace66f2d4f9" FOREIGN KEY ("parentCommentId") REFERENCES "c0"."comments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."chapters" ADD CONSTRAINT "FK_7301f587a038330b1d7abb66686" FOREIGN KEY ("mangaId") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."chapters" ADD CONSTRAINT "FK_31eee0bf1ffa9a42d06d8dad2e6" FOREIGN KEY ("createdById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."chapters" ADD CONSTRAINT "FK_89f68ec0e0c159e03dd265e7795" FOREIGN KEY ("updatedById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."ratings" ADD CONSTRAINT "FK_4d0b0e3a4c4af854d225154ba40" FOREIGN KEY ("userId") REFERENCES "c0"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."ratings" ADD CONSTRAINT "FK_53e4eaafe4365f8e459cc086ce1" FOREIGN KEY ("mangaId") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."favorites" ADD CONSTRAINT "FK_e747534006c6e3c2f09939da60f" FOREIGN KEY ("userId") REFERENCES "c0"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."favorites" ADD CONSTRAINT "FK_d85fedf5ac0108a3cb262a68d70" FOREIGN KEY ("mangaId") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."mangas" ADD CONSTRAINT "FK_cc22de2e0e8a61868f9a973956f" FOREIGN KEY ("createdById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."mangas" ADD CONSTRAINT "FK_caeec1afc6eff8ab4d447ab0357" FOREIGN KEY ("updatedById") REFERENCES "c0"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."reading_history" ADD CONSTRAINT "FK_430f7bf314cbcd6daf4d25b3aaf" FOREIGN KEY ("lastChapterReadId") REFERENCES "c0"."chapters"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."reading_history" ADD CONSTRAINT "FK_f98374aa608f580c8391ecc7574" FOREIGN KEY ("lastPageReadId") REFERENCES "c0"."pages"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."reading_history" ADD CONSTRAINT "FK_0a84665f42ef7d9ed671a6828e4" FOREIGN KEY ("userId") REFERENCES "c0"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."reading_history" ADD CONSTRAINT "FK_3df1ae401e85e47c5607205e124" FOREIGN KEY ("mangaId") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."manga_tags" ADD CONSTRAINT "FK_1109d1c70cab1729fc7b701b04f" FOREIGN KEY ("manga_id") REFERENCES "c0"."mangas"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."manga_tags" ADD CONSTRAINT "FK_1148bf09ecca3c6ad1a18bd30a5" FOREIGN KEY ("tag_id") REFERENCES "c0"."tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments_closure" ADD CONSTRAINT "FK_89a2762362d968c2939b6fab193" FOREIGN KEY ("id_ancestor") REFERENCES "c0"."comments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "c0"."comments_closure" ADD CONSTRAINT "FK_d2164211fd6ab117cfb2ab8ba96" FOREIGN KEY ("id_descendant") REFERENCES "c0"."comments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
